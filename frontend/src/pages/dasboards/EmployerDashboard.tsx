...
import { Briefcase, Users, FileText, LogOut, Plus, MapPin, Clock, DollarSign, Building2, User, ChevronRight, CheckCircle, XCircle } from 'lucide-react';
        ...
        <div className="dashboard-layout">
            ...
            <main className="dashboard-main" style={{ overflowY: 'auto', padding: '2rem' }}>
                <header className="dashboard-header" style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div>
                        <h2>Welcome back, {user?.firstName || 'Employer'}! 👋</h2>
                        <p style={{ color: 'var(--color-text-muted)' }}>Manage your internship postings</p>
                    </div>
                    <button 
                        onClick={() => navigate('/employer/post-internship')}
                        style={{ padding: '0.75rem 1.5rem', borderRadius: '8px', background: 'var(--color-primary)', color: 'white', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: 'bold' }}
                    >
