...
import { Briefcase, FileText, Star, LogOut, Code, Plus, Trash2, Search, User } from 'lucide-react';
import '../../styles/dashboard.css';
import { studentService, internshipService } from '../../services/api';
        ...
        <div className="dashboard-layout">
            ...
            <main className="dashboard-main" style={{ overflowY: 'auto', padding: '2rem' }}>
                <header className="dashboard-header" style={{ marginBottom: '2rem' }}>
                    <h2>My Skills 🛠️</h2>
                    <p style={{ color: 'var(--color-text-muted)' }}>Mange your proficiencies to get better recommendations</p>
                </header>
