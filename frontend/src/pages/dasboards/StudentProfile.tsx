...
import { Briefcase, FileText, Star, LogOut, Code, Search, User, Upload } from 'lucide-react';
        ...
        <div className="dashboard-layout">
            ...
            <main className="dashboard-main" style={{ overflowY: 'auto', padding: '2rem' }}>
                <header className="dashboard-header" style={{ marginBottom: '2rem' }}>
                    <h2>My Profile</h2>
                    <p style={{ color: 'var(--color-text-muted)' }}>Complete your profile to get better recommendations</p>
                </header>
